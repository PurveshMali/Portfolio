...
const SkillCard = ({ name, img, desc }) => {
  return (
    <div className="relative flex flex-col justify-center items-center bg-[#070707] border aspect-1/1 w-30 border-[#333333] text-gray-300 text-xs md:text-sm px-3 py-2 rounded-md font-mono hover:border-[#5e5e5e] overflow-hidden">
      <img src={img} alt={name} className="w-16 h-16 object-contain" />
      <h2 className="font-mono text-lg mt-2 text-center">{name}</h2>
